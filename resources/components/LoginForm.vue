    ...
    <div class="max-w-lg">
        ...
        <div class="sm:px-12 px-8 py-8 bg-white shadow-md rounded-lg w-auto">
            <form class="space-y-6">
                <label class="block">
                    <span class="text-gray-700 font-medium">Adresse email</span>
                    <input
                        type="email"
                ...
                <label class="block">
                    <span class="text-gray-700 font-medium">Mot de passe</span>
                    <input
                        type="email"
                        class="form-input mt-1 block w-full focus:shadow-outline-purple focus:border-purple-300 transition duration-150 ease-in-out"
                    />
                ...
                <div
                    class="mt-6 flex items-center justify-between flex-wrap xs:space-y-0 space-y-2"
                >
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-6 flex justify-between space-x-3">
                        <a
                            href=""
                            class="w-1/3 flex justify-center items-center text-center py-2 px-3 border border-gray-300 rounded-md text-gray-500 hover:border-gray-400 focus:outline-none focus:border-gray-400 sm:text-sm"
                        >
                            <svg
